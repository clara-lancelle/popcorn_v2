    ...
    <main className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <section>
        ...
        <p className="text-sm text-gray-600 mt-2">
          In accordance with applicable law, the publisher has chosen not to
      ...
      <section>
        ...
        <p>
          Popcorn uses data provided by the IMDb API to display information
          about movies, including titles, descriptions, cast and trailers.
        </p>
        <p>
          Popcorn is not affiliated with IMDb. IMDb is a registered trademark of
          IMDb.com, Inc.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The publisher strives to provide accurate information but cannot
          guarantee the accuracy, completeness or availability of the content.
        </p>
      </section>
    </main>
  );
