    ...
    return (
        <main className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <section>
                ...
                <p>
                    Popcorn does not require users to provide personal
                    identifying information such as name, address or email.
                </p>
            ...
            <section>
                ...
                <p>
                    This data is used solely to enhance the user experience and
            ...
            <section>
                ...
                <p>
                    Certain anonymous usage data may be shared with third-party
                    service providers, such as Google LLC, for analytics
                    purposes, and only after explicit user consent.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    In accordance with applicable data protection laws, users
                    may request access to or deletion of their data.
                </p>
                <p>
                    Contact: <strong>lncl.pro@hotmail.com</strong>
                </p>
            </section>
